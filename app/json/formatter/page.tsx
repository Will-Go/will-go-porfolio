		...
		<main className="relative min-h-screen p-6 md:p-12 lg:p-24 selection:text-black selection:bg-slate-300 overflow-x-hidden animate-fade-in">
			<Reveal>
				<div className="max-w-7xl mx-auto">
					<h1 className="text-4xl md:text-5xl font-bold mb-4 text-center bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
						JSON Formatter
					</h1>
						...
						<Reveal>
							<Card className="flex flex-col h-[600px]">
								...
								<textarea
									...
									className={cn(
										"flex-1 p-4 bg-gray-50 dark:bg-gray-900 text-black!",
										...
										<div>
											{showTreeView ? (
												...
												<div>
													...
													<div className="p-3 bg-white dark:bg-gray-800 rounded-md border overflow-x-auto text-sm font-mono">
														<div className="flex">
															<div className="pr-4 border-r border-gray-300 dark:border-gray-600 select-none text-gray-500 dark:text-gray-500">
																{getFormattedOutput()
																	.split("\n")
																	.map((_, i) => (
												...
												<div>
													...
													<div className="p-3 bg-white text-black dark:bg-gray-800 dark:text-white rounded-md overflow-x-auto text-sm font-mono border">
														<div className="flex">
															<div className="pr-4 border-r border-gray-300 dark:border-gray-600 select-none text-gray-500 dark:text-gray-500">
																{getFormattedOutput()
																	.split("\n")
