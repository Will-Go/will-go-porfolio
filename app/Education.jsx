...
function Education() {
  return (
    <div
      ...
      <div className="flex flex-col shadow-sm shadow-zinc-400 p-3 rounded-lg w-full  bg-gradient-to-tl from-black  bg-zinc-900 hover:bg-zinc-800 transition-all duration-500">
